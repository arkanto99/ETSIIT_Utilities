...
public class IndicacionesDbHelper extends SQLiteOpenHelper {
    ...
    private void cargarDatos(SQLiteDatabase db){
        ...
        nuevaIndicacion(db,new Indicacion("Banho_Clase","banho_clase5","Camina recto",2,5));
        nuevaIndicacion(db,new Indicacion("Banho_Clase","banho_clase6","Camina recto",2,6));
        nuevaIndicacion(db,new Indicacion("Banho_Clase","banho_clase7","Camina recto",2,7));
        nuevaIndicacion(db,new Indicacion("Banho_Clase","banho_clase8","Camina recto",2,8));
        nuevaIndicacion(db,new Indicacion("Banho_Clase","banho_clase9","Camina recto",2,9));
        nuevaIndicacion(db,new Indicacion("Banho_Clase","banho_clase10","Camina recto",2,10));
        nuevaIndicacion(db,new Indicacion("Banho_Clase","banho_clase11","Camina recto",2,11));
        nuevaIndicacion(db,new Indicacion("Banho_Clase","banho_clase12","Camina recto",2,12));
        nuevaIndicacion(db,new Indicacion("Banho_Clase","banho_clase13","Camina recto",2,13));
        nuevaIndicacion(db,new Indicacion("Banho_Clase","banho_clase14","Camina recto",2,14));
        nuevaIndicacion(db,new Indicacion("Banho_Clase","banho_clase15","Camina recto",2,15));
        nuevaIndicacion(db,new Indicacion("Banho_Clase","banho_clase16","Camina recto",2,16));
        nuevaIndicacion(db,new Indicacion("Banho_Clase","banho_clase17","Camina recto",2,17));
        nuevaIndicacion(db,new Indicacion("Banho_Clase","banho_clase18","Camina recto",2,18));
        nuevaIndicacion(db,new Indicacion("Banho_Clase","banho_clase19","Camina recto",2,19));
        nuevaIndicacion(db,new Indicacion("Banho_Clase","banho_clase20","Camina recto",2,20));
        nuevaIndicacion(db,new Indicacion("Banho_Clase","banho_clase21","Camina recto",2,21));
        nuevaIndicacion(db,new Indicacion("Banho_Clase","banho_clase22","Camina recto",2,22));
        nuevaIndicacion(db,new Indicacion("Banho_Clase","banho_clase23","Camina recto",2,23));
        nuevaIndicacion(db,new Indicacion("Banho_Clase","banho_clase24","Camina recto",2,24));
        nuevaIndicacion(db,new Indicacion("Banho_Clase","banho_clase25","Camina recto",2,25));
        nuevaIndicacion(db,new Indicacion("Banho_Clase","banho_clase26","Camina recto",2,26));
        nuevaIndicacion(db,new Indicacion("Banho_Clase","banho_clase27","Camina recto",2,27));
        nuevaIndicacion(db,new Indicacion("Banho_Clase","banho_clase28","Camina recto",2,28));
        nuevaIndicacion(db,new Indicacion("Banho_Clase","banho_clase29","Camina recto",2,29));
        nuevaIndicacion(db,new Indicacion("Banho_Clase","banho_clase30","Camina recto",2,30));
